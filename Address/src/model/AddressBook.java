...
public class AddressBook implements Serializable {
	...
	public AddressBook(String id, String name, int gender, Long phonenumber, String emailaddress, int postalcode,
	...
	public AddressBook(InputAddressBook inputAddressBook) {
	...
	public void createAddressBook(InputAddressBook inputAddressBook) {
		...
		long birthMiliTime = birth.getTime();
		Date date = new Date();
		long miliTime = date.getTime();
		long age = (miliTime - birthMiliTime) / 1000 / 60 / 60 / 24 / 365; 
		this.age = (int)age;
